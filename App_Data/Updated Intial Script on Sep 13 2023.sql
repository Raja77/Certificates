...
/****** Object: SqlProcedure [dbo].[spApplications] Script Date: 13-09-2023 14:44:12 ******/
SET ANSI_NULLS ON
GO
...
BEGIN  
	...
	--DECLARE @RollNo int= 20201201   
		...
		inner  join tbStudentDetails td on sa.RollNo = td.classrollno where rollno=@RollNo and  IsCertificateVerified=1  and
		ISNULL(IsCertificateReady, 0) = 0 order by AppliedOn desc 
