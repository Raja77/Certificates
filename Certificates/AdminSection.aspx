<%@ Page Title="View Certificate(s)" Language="C#" MasterPageFile="~/ModuleSite.Master" AutoEventWireup="true" CodeBehind="AdminSection.aspx.cs"
    Inherits="Certificates.AdminSection" EnableViewState="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dvViewCertificate" runat="server" visible="false">
        ...
        <hr />
        <asp:GridView ID="grdAdminSectionCertificatesView" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Is Verified" HeaderStyle-CssClass="headerWidth">
                    <ItemTemplate>
                        <asp:Label ID="lblVerified" runat="server" Text='<%# Boolean.Parse(Eval("IsAdminSectionVerified").ToString()) ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="AdminSectionRemarks" HeaderText="Remarks">
                    <HeaderStyle />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane1" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdAdminFreshApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdAdminApplicationDetails_RowCommand"
                                        OnRowDataBound="grdAdminApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdAdminFreshApplicationDetails_Sorting" OnPageIndexChanging="grdAdminFreshApplicationDetails_PageIndexChanging" PageSize="10">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Remarks" HeaderStyle-CssClass="headerWidth">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamSectionRemarks" runat="server" Text='<%# Eval("TruncatedAdminRemarks")%>' ToolTip='<%# Eval("AdminSectionRemarks")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                      ...
                      Eval("AdminSectionVerifiedOn", "{0:dd/MMM/yyyy}")    + ";" + Eval("AdminSectionRemarks")+ ";" + Eval("AppliedOn", "{0:dd/MMM/yyyy}")
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane2" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdAdminOverdueApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdAdminApplicationDetails_RowCommand"
                                        OnRowDataBound="grdAdminApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdAdminOverdueApplicationDetails_Sorting" OnPageIndexChanging="grdAdminOverdueApplicationDetails_PageIndexChanging" PageSize="10">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane3" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdAdminVerifiedApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdAdminApplicationDetails_RowCommand"
                                        OnRowDataBound="grdAdminApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdAdminVerifiedApplicationDetails_Sorting" OnPageIndexChanging="grdAdminVerifiedApplicationDetails_PageIndexChanging" PageSize="50">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
