<%@ Page Title="View Certificate(s)" Language="C#" MasterPageFile="~/ModuleSite.Master" AutoEventWireup="true" CodeBehind="PhysicalEducationSection.aspx.cs"
    Inherits="Certificates.PhysicalEducationSection" EnableViewState="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dvViewCertificate" runat="server" visible="false">
        ...
        <hr />
        <asp:GridView ID="grdPhysicalEduSectionCertificatesView" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Is Verified" HeaderStyle-CssClass="headerWidth">
                    <ItemTemplate>
                        <asp:Label ID="lblVerified" runat="server" Text='<%# Boolean.Parse(Eval("IsPhysicalEduSectionVerified").ToString()) ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="PhysicalEduSectionRemarks" HeaderText="Remarks">
                    <HeaderStyle />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane1" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdPhysicalEduFreshApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdPhysicalEduApplicationDetails_RowCommand"
                                        OnRowDataBound="grdPhysicalEduApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdPhysicalEduFreshApplicationDetails_Sorting" OnPageIndexChanging="grdPhysicalEduFreshApplicationDetails_PageIndexChanging" PageSize="10">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Remarks" HeaderStyle-CssClass="headerWidth">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamSectionRemarks" runat="server" Text='<%# Eval("TruncatedPhysicalEduRemarks")%>' ToolTip='<%# Eval("PhysicalEduSectionRemarks")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane2" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdPhysicalEduOverdueApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdPhysicalEduApplicationDetails_RowCommand"
                                        OnRowDataBound="grdPhysicalEduApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdPhysicalEduOverdueApplicationDetails_Sorting" OnPageIndexChanging="grdPhysicalEduOverdueApplicationDetails_PageIndexChanging" PageSize="10">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane3" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdPhysicalEduVerifiedApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdPhysicalEduApplicationDetails_RowCommand"
                                        OnRowDataBound="grdPhysicalEduApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdPhysicalEduVerifiedApplicationDetails_Sorting" OnPageIndexChanging="grdPhysicalEduVerifiedApplicationDetails_PageIndexChanging" PageSize="50">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
