<%@ Page Title="View Certificate(s)" Language="C#" MasterPageFile="~/ModuleSite.Master" AutoEventWireup="true" CodeBehind="ExamSection.aspx.cs"
    Inherits="Certificates.ExamSection" EnableViewState="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dvViewCertificate" runat="server" visible="false">
        ...
        <hr />
        <asp:GridView ID="grdExamSectionCertificatesView" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Is Verified" HeaderStyle-CssClass="headerWidth">
                    <ItemTemplate>
                        <asp:Label ID="lblVerified" runat="server" Text='<%# Boolean.Parse(Eval("IsExamSectionVerified").ToString()) ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="ExamSectionRemarks" HeaderText="Remarks">
                    <HeaderStyle />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
        ...
        <div class="mb-4 row">
            ...
            <div class="col-sm-9" style="text-align:right;">
                <asp:Button ID="btnBack" runat="server" CssClass="btn" Text="Back to Student Application Details" OnClick="btnBack_Click" />
            </div>
        </div>
    </div>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane1" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdExamFreshApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdExamApplicationDetails_RowCommand"
                                        OnRowDataBound="grdExamApplicationDetails_RowDataBound">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Remarks" HeaderStyle-CssClass="headerWidth">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamSectionRemarks" runat="server" Text='<%# Eval("TruncatedExamRemarks")%>' ToolTip='<%# Eval("ExamSectionRemarks")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                      ...
                      Eval("ExamSectionVerifiedOn", "{0:dd/MMM/yyyy}")    + ";" + Eval("ExamSectionRemarks")+ ";" + Eval("AppliedOn", "{0:dd/MMM/yyyy}")%>'
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane2" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdExamOverdueApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdExamApplicationDetails_RowCommand"
                                        OnRowDataBound="grdExamApplicationDetails_RowDataBound">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Actions" HeaderStyle-CssClass="headerWidth">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkEdit" runat="server" CommandArgument='<%#Eval("Id") + ";" + Eval("Name") + ";" + Eval("CertificateType") + ";" +
                                Eval("IsAdminSectionVerified") + ";" + Eval("IsExamSectionVerified") + ";" + Eval("Parentage") + ";" + Eval("dob", "{0:dd/MMM/yyyy}") + ";" +
                                Eval("ExamSectionVerifiedOn", "{0:dd/MMM/yyyy}")+ ";" + Eval("ExamSectionRemarks") + ";" + 
                              Eval("AppliedOn", "{0:dd/MMM/yyyy}")%>'
                                                        CommandName="EditRecord" Text="Edit" ToolTip="Click to update the details"></asp:LinkButton>
                                                    <asp:LinkButton ID="lnkView" runat="server" CommandArgument='<%#Eval("Id")%>' CommandName="ViewRecord" Text="View" ToolTip="Click to view the details"></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane3" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdExamVerifiedApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdExamApplicationDetails_RowCommand"
                                        OnRowDataBound="grdExamApplicationDetails_RowDataBound">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
