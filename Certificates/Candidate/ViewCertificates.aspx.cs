    ...
    public partial class ViewCertificates : Page
    {
        ...
        protected void GetCertificateDetails()
        {
            try
            {
                 ...
                 */
                sqlCmd.Parameters.AddWithValue("@RollNo", Session["RollNo"]);
                sqlCmd.Parameters.AddWithValue("@ActionType", "FetchSADetailsByRollNo");
                SqlDataAdapter sqlSda = new SqlDataAdapter(sqlCmd);
                sqlSda.Fill(ds);
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {                    
                    grdCertificatesDetail.DataSource = ds.Tables[0];
                    grdCertificatesDetail.DataBind();
                    countAppliedApplication.InnerText = ds.Tables[0].Rows.Count.ToString();
                }
                else
                {
                    grdCertificatesDetail.DataSource = ds.Tables[0];
                ...
                else
                {
                    grdRejectedApplications.DataSource = ds.Tables[1];
                    grdRejectedApplications.DataBind();
                    countRejectedApplications.InnerText = "0";
                }
                if (ds.Tables.Count > 0 && ds.Tables[2].Rows.Count > 0)
                {
                    grdPrintCertificatesDetail.DataSource = ds.Tables[2];
                    grdPrintCertificatesDetail.DataBind();
                    countPrintApplications.InnerText = ds.Tables[2].Rows.Count.ToString();
                }
                else
                {
                    grdPrintCertificatesDetail.DataSource = ds.Tables[2];
        ...
        //protected void grdPrintCertificatesDetail_RowCommand(object sender, GridViewCommandEventArgs e)
        //{
            ...
            using (System.IO.MemoryStream memoryStream = new System.IO.MemoryStream())
            {
                ...
                switch (certificateType)
                {
                    ...
                    case "Discharge/Transfer Certificate":
                        ...
                        /*t_p1.Add(t_a16);*/
                        t_p1.Add(t_a17); t_p1.Add(t_a18); t_p1.Add(t_a19); t_p1.Add(t_a20); t_p1.Add(t_a21); t_p1.Add(t_a22); t_p1.Add(t_a23);
