<%@ Page Title="View Certificate(s)" Language="C#" MasterPageFile="~/ModuleSite.Master" AutoEventWireup="true" CodeBehind="LibrarySection.aspx.cs"
    Inherits="Certificates.LibrarySection" EnableViewState="true" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="dvViewCertificate" runat="server" visible="false">
        ...
        <hr />
        <asp:GridView ID="grdLibrarySectionCertificatesView" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Is Verified" HeaderStyle-CssClass="headerWidth">
                    <ItemTemplate>
                        <asp:Label ID="lblVerified" runat="server" Text='<%# Boolean.Parse(Eval("IsLibrarySectionVerified").ToString()) ? "Yes" : "No" %>'></asp:Label>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="LibrarySectionRemarks" HeaderText="Remarks">
                    <HeaderStyle />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane1" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdLibraryFreshApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdLibraryApplicationDetails_RowCommand"
                                        OnRowDataBound="grdLibraryApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdLibraryFreshApplicationDetails_Sorting" OnPageIndexChanging="grdLibraryFreshApplicationDetails_PageIndexChanging" PageSize="10">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Remarks" HeaderStyle-CssClass="headerWidth">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExamSectionRemarks" runat="server" Text='<%# Eval("TruncatedLibraryRemarks")%>' ToolTip='<%# Eval("LibrarySectionRemarks")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                      ...
                      Eval("LibrarySectionVerifiedOn", "{0:dd/MMM/yyyy}")    + ";" + Eval("LibrarySectionRemarks")+ ";" + Eval("AppliedOn", "{0:dd/MMM/yyyy}")
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane2" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdLibraryOverdueApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdLibraryApplicationDetails_RowCommand"
                                        OnRowDataBound="grdLibraryApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdLibraryOverdueApplicationDetails_Sorting" OnPageIndexChanging="grdLibraryOverdueApplicationDetails_PageIndexChanging" PageSize="10">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
                ...
                <ajaxToolkit:AccordionPane ID="AccordionPane3" runat="server">
                    ...
                    <Content>
                        ...
                        <table class="tblcss">
                            <tr>
                                <td>
                                    <asp:GridView ID="grdLibraryVerifiedApplicationDetails" CellPadding="0" CellSpacing="0" CssClass="table table-bordered table-striped"
                                        DataKeyNames="Id" GridLines="None" runat="server" AutoGenerateColumns="false" OnRowCommand="grdLibraryApplicationDetails_RowCommand"
                                        OnRowDataBound="grdLibraryApplicationDetails_RowDataBound" AllowPaging="true" AllowSorting="true"
                                        OnSorting="grdLibraryVerifiedApplicationDetails_Sorting" OnPageIndexChanging="grdLibraryVerifiedApplicationDetails_PageIndexChanging" PageSize="50">
                                        <HeaderStyle />
                                        <EmptyDataTemplate>
