...
<div class="d-flex" id="wrapper">
    <div class="bg-light border-light" id="sidebar-wrapper">
        ...
        <div class="list-group list-group-flush">
            ...
            <a href="../Certificates/LibrarySection.aspx" class="list-group-item list-group-item-action bg-light"><i class="fa-solid fa-gauge-simple"></i>&nbsp;Library Section</a>
            <a href="../Certificates/HostelSection.aspx" class="list-group-item list-group-item-action bg-light"><i class="fa-solid fa-gauge-simple"></i>&nbsp;Hostel Section</a>
            <a href="../Certificates/PhysicalEducationSection.aspx" class="list-group-item list-group-item-action bg-light"><i class="fa-solid fa-gauge-simple"></i>&nbsp;Physical Education Section</a>
            ...
            <a href="../Certificates/ViewAllApplications.aspx" class="list-group-item list-group-item-action bg-light"><i class="fa-solid fa-gauge-simple"></i>&nbsp;View All Applications</a>
        </div>
    </div>
</div>
